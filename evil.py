...
TELEGRAM_BOT_TOKEN = '7836401331:AAFZ-VJ_P4j8Yi6WCg9l5AbRh4bCR6Cvui4'
ADMIN_USER_ID = 945650098
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the Darinda VIP DDOS🔥*\n\n"
...
async def Darinda(update: Update, context: CallbackContext):
    ...
    if len(args) != 2:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /Darinda <add|rem> <user_id>*", parse_mode='Markdown')
        return
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        ...
        attack_in_progress = False
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*Thank you for using our Darinda DDOS Bot!*", parse_mode='Markdown')
